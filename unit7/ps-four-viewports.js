...
function init() {
	...
	// FRONT
	frontCam = new THREE.OrthographicCamera(-aspectRatio*viewSize / 2, 
	...
	// SIDE
	sideCam = new THREE.OrthographicCamera(-aspectRatio*viewSize / 2, 
											aspectRatio*viewSize / 2,
											viewSize / 2, -viewSize / 2,
											-1000, 1000 );
	// set Y to be the up axis
...
function render() {
	...
	// move down a unit in x and look front at bird
